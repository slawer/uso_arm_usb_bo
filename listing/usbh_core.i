...
#line 25 "Libraries\\STM32_USB_HOST_Library\\usbh_core.c"
...
#line 26 "Libraries\\STM32_USB_HOST_Library\\usbh_core.c"
...
#line 27 "Libraries\\STM32_USB_HOST_Library\\usbh_core.c"
...
#line 28 "Libraries\\STM32_USB_HOST_Library\\usbh_core.c"
#line 29 "Libraries\\STM32_USB_HOST_Library\\usbh_core.c"
...
USBH_Status USBH_DeInit(USB_OTG_CORE_HANDLE *pdev, USBH_HOST *phost)
{
  ...
  phost->Control.ep0size = 64;  
  
  phost->device_prop.address = 0;
  phost->device_prop.speed = 1;
...
static USBH_Status USBH_HandleEnum(USB_OTG_CORE_HANDLE *pdev, USBH_HOST *phost)
{
  ...
  case ENUM_SET_ADDR: 
    ...
    if ( USBH_SetAddress(pdev, phost, 1) == USBH_OK)
    {
      phost->device_prop.address = 1;
