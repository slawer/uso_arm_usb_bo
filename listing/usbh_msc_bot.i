...
#line 24 "Libraries\\STM32_USB_HOST_Library\\usbh_msc_bot.c"
#line 25 "Libraries\\STM32_USB_HOST_Library\\usbh_msc_bot.c"
#line 26 "Libraries\\STM32_USB_HOST_Library\\usbh_msc_bot.c"
#line 27 "Libraries\\STM32_USB_HOST_Library\\usbh_msc_bot.c"
#line 28 "Libraries\\STM32_USB_HOST_Library\\usbh_msc_bot.c"
...
#line 29 "Libraries\\STM32_USB_HOST_Library\\usbh_msc_bot.c"
...
static uint32_t BOTStallErrorCount;    
...
void USBH_MSC_Init(USB_OTG_CORE_HANDLE *pdev )
{
  ...
  {      
    USBH_MSC_CBWData.field.CBWSignature = 0x43425355;
    USBH_MSC_CBWData.field.CBWTag = 0x20304050;
...
void USBH_MSC_HandleBOTXfer (USB_OTG_CORE_HANDLE *pdev ,USBH_HOST *phost)
{
  ...
  {  
    ...
    case 1:
      ...
      USBH_MSC_BOTXferParam.BOTStateBkp = 1;
      USBH_MSC_BOTXferParam.BOTState = 2;
    ...
    case 2:
      ...
      { 
        BOTStallErrorCount = 0;
        USBH_MSC_BOTXferParam.BOTStateBkp = 2; 
        
         
        xferDirection = (USBH_MSC_CBWData.field.CBWFlags & 0x80);
        ...
        if ( USBH_MSC_CBWData.field.CBWTransferLength != 0 )
        {
          ...
          if (xferDirection == 0x80)
          {
             
            USBH_MSC_BOTXferParam.BOTState = 3;
          }
          else
          {
             
            USBH_MSC_BOTXferParam.BOTState = 4;
          } 
        }
        
        else
        { 
          USBH_MSC_BOTXferParam.BOTState = 5;
        }
      ...
      {
        error_direction = 1;
        USBH_MSC_BOTXferParam.BOTState  = 8;
      }
      break;
    ...
    case 3:
      ...
      if((URB_Status == URB_DONE) ||(USBH_MSC_BOTXferParam.BOTStateBkp != 3))
      {
        BOTStallErrorCount = 0;
        USBH_MSC_BOTXferParam.BOTStateBkp = 3;    
        
        if(remainingDataLength > 0x40)
        {
      ...
      else if(URB_Status == URB_STALL)
      {
        ...
        error_direction = 0;
        USBH_MSC_BOTXferParam.BOTState  = 7;
        ...
        USBH_MSC_BOTXferParam.BOTStateBkp = 5;
    ...
    case 4:
      ...
      {
        BOTStallErrorCount = 0;
        USBH_MSC_BOTXferParam.BOTStateBkp = 4;    
        if(remainingDataLength > 0x40)
        {
          USBH_BulkSendData (pdev,
                             datapointer, 
                             ...
                             MSC_Machine.hc_num_out);
          datapointer = datapointer + 0x40;
          remainingDataLength = remainingDataLength - 0x40;
        }
        else if ( remainingDataLength == 0)
        {
    ...
    case 5:
        ...
        USBH_MSC_BOTXferParam.DataLength = 63;
        ...
        USBH_BulkReceiveData (pdev,
                              ...
                              63 , 
                              MSC_Machine.hc_num_in);
        USBH_MSC_BOTXferParam.BOTState = 6;    
    ...
    case 7: 
      status = USBH_MSC_BOT_Abort(pdev, phost, 0);
      if (status == USBH_OK)
      {
         
        if (error_direction == 2)
        { 
          USBH_MSC_BOTXferParam.BOTState = 8;
        }
        else
    ...
    case 8: 
      status = USBH_MSC_BOT_Abort(pdev, phost, 1);
      if ( status == USBH_OK)
      {  
        USBH_MSC_BOTXferParam.BOTState = USBH_MSC_BOTXferParam.BOTStateBkp;        
      }
...
uint8_t USBH_MSC_DecodeCSW(USB_OTG_CORE_HANDLE *pdev , USBH_HOST *phost)
{
  ...
  if(HCD_IsDeviceConnected(pdev))
  {
    ...
    {  
      ...
      if(USBH_MSC_CSWData.field.CSWSignature == 0x53425355)
      { 
