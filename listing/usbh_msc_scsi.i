...
#line 24 "Libraries\\STM32_USB_HOST_Library\\usbh_msc_scsi.c"
#line 25 "Libraries\\STM32_USB_HOST_Library\\usbh_msc_scsi.c"
#line 26 "Libraries\\STM32_USB_HOST_Library\\usbh_msc_scsi.c"
#line 27 "Libraries\\STM32_USB_HOST_Library\\usbh_msc_scsi.c"
#line 28 "Libraries\\STM32_USB_HOST_Library\\usbh_msc_scsi.c"
...
uint8_t USBH_MSC_TestUnitReady (USB_OTG_CORE_HANDLE *pdev)
{
  ...
  {  
    ...
    case CMD_SEND_STATE:  
      ...
      USBH_MSC_CBWData.field.CBWFlags = 0x00;
      ...
      USBH_MSC_BOTXferParam.BOTState = 1;
...
uint8_t USBH_MSC_ReadCapacity10(USB_OTG_CORE_HANDLE *pdev)
{
  ...
  {  
    ...
    case CMD_SEND_STATE:
      ...
      USBH_MSC_CBWData.field.CBWFlags = 0x80;
...
uint8_t USBH_MSC_ModeSense6(USB_OTG_CORE_HANDLE *pdev)
{
  ...
  {  
    ...
    case CMD_SEND_STATE:
      ...
      USBH_MSC_CBWData.field.CBWCB[0]  = 0x1A; 
      USBH_MSC_CBWData.field.CBWCB[2]  = 0x00 |                                          0x3F;
    ...
    case CMD_WAIT_STATUS:
      if(USBH_MSC_BOTXferParam.BOTXferStatus == USBH_MSC_OK)
      {
        ...
        if ( USBH_DataInBuffer[2] & 0x80)
        {
          USBH_MSC_Param.MSWriteProtect   = 0x01;
        }
        else
        {
...
uint8_t USBH_MSC_RequestSense(USB_OTG_CORE_HANDLE *pdev)
{
  ...
  {  
    ...
    case CMD_SEND_STATE:
      ...
      USBH_MSC_CBWData.field.CBWCB[1]  = 0X00;
      USBH_MSC_CBWData.field.CBWCB[4]  = 63;
