...
#line 24 "Libraries\\STM32_USB_OTG_Driver\\usb_hcd_int.c"
#line 25 "Libraries\\STM32_USB_OTG_Driver\\usb_hcd_int.c"
...
#line 26 "Libraries\\STM32_USB_OTG_Driver\\usb_hcd_int.c"


    #pragma O0
#line 37 "Libraries\\STM32_USB_OTG_Driver\\usb_hcd_int.c"
...
static uint32_t USB_OTG_USBH_handle_hc_ISR (USB_OTG_CORE_HANDLE *pdev)
{
  ...
  for (i = 0; i < pdev->cfg.host_channels ; i++)
  {
    ...
    {
      hcchar.d32 = (*(volatile uint32_t *)&pdev->regs . HC_REGS[i]->HCCHAR);
...
static uint32_t USB_OTG_USBH_handle_nptxfempty_ISR (USB_OTG_CORE_HANDLE *pdev)
{
  ...
  hnptxsts.d32 = (*(volatile uint32_t *)&pdev->regs . GREGS->HNPTXSTS);
      ...
      (pdev->host.hc[hnptxsts.b.chnum].xfer_len != 0))
  {
    ...
    if (len > pdev->host.hc[hnptxsts.b.chnum].xfer_len)
    {
      ...
      (*(volatile uint32_t *)&pdev->regs . GREGS->GINTMSK = ((((*(volatile uint32_t *)&pdev->regs . GREGS->GINTMSK)) & ~intmsk . d32) | 0 ));       
    }
...
static uint32_t USB_OTG_USBH_handle_ptxfempty_ISR (USB_OTG_CORE_HANDLE *pdev)
{
  ...
  hptxsts.d32 = (*(volatile uint32_t *)&pdev->regs . HREGS->HPTXSTS);
...
static uint32_t USB_OTG_USBH_handle_port_ISR (USB_OTG_CORE_HANDLE *pdev)
{
  ...
  hprt0_dup.d32 = (*(volatile uint32_t *)pdev->regs . HPRT0);
  ...
  if (hprt0.b.prtenchng)
  {
    ...
    if (hprt0.b.prtena == 1)
    {
          ...
          (hprt0.b.prtspd == 1))
      {
        ...
        hcfg.d32 = (*(volatile uint32_t *)&pdev->regs . HREGS->HCFG);
        
        if (hprt0.b.prtspd == 2)
        {
          (*(volatile uint32_t *)&pdev->regs . HREGS->HFIR = 6000);
          if (hcfg.b.fslspclksel != 2)
          {
            if(pdev->cfg.coreID == USB_OTG_FS_CORE_ID)
            {          
              USB_OTG_InitFSLSPClkSel(pdev ,2 );
            }          
            do_reset = 1;
          }
        }
        else
        {
          ...
          (*(volatile uint32_t *)&pdev->regs . HREGS->HFIR = 48000);            
          if (hcfg.b.fslspclksel != 1)
          {
            USB_OTG_InitFSLSPClkSel(pdev ,1 );
            do_reset = 1;
          }
        }
      }
  ...
  (*(volatile uint32_t *)pdev->regs . HPRT0 = hprt0_dup . d32);
...
uint32_t USB_OTG_USBH_handle_hc_n_Out_ISR (USB_OTG_CORE_HANDLE *pdev , uint32_t num)
{
  ...
  hcint.d32 = (*(volatile uint32_t *)&hcreg->HCINT);
  hcintmsk.d32 = (*(volatile uint32_t *)&hcreg->HCGINTMSK);
  hcint.d32 = hcint.d32 & hcintmsk.d32;
  
  hcchar.d32 = (*(volatile uint32_t *)&pdev->regs . HC_REGS[num]->HCCHAR);
  
  if (hcint.b.ahberr)
  {
    { USB_OTG_HCINTn_TypeDef hcint_clear; hcint_clear . d32 = 0; hcint_clear . b . ahberr = 1; (*(volatile uint32_t *)&((hcreg)->HCINT) = hcint_clear . d32); };
    { USB_OTG_HCGINTMSK_TypeDef GINTMSK; GINTMSK . d32 = (*(volatile uint32_t *)&pdev->regs . HC_REGS[num]->HCGINTMSK); GINTMSK . b . chhltd = 1; (*(volatile uint32_t *)&pdev->regs . HC_REGS[num]->HCGINTMSK = GINTMSK . d32);};
  } 
  else if (hcint.b.ack)
  {
    { USB_OTG_HCINTn_TypeDef hcint_clear; hcint_clear . d32 = 0; hcint_clear . b . ack = 1; (*(volatile uint32_t *)&((hcreg)->HCINT) = hcint_clear . d32); };
  }
  ...
  else if (hcint.b.xfercompl)
  {
    ...
    { USB_OTG_HCINTn_TypeDef hcint_clear; hcint_clear . d32 = 0; hcint_clear . b . xfercompl = 1; (*(volatile uint32_t *)&((hcreg)->HCINT) = hcint_clear . d32); };
    pdev->host.HC_Status[num] = HC_XFRC;            
  }
  
  else if (hcint.b.stall)
  {
    { USB_OTG_HCINTn_TypeDef hcint_clear; hcint_clear . d32 = 0; hcint_clear . b . stall = 1; (*(volatile uint32_t *)&((hcreg)->HCINT) = hcint_clear . d32); };
    { USB_OTG_HCGINTMSK_TypeDef GINTMSK; GINTMSK . d32 = (*(volatile uint32_t *)&pdev->regs . HC_REGS[num]->HCGINTMSK); GINTMSK . b . chhltd = 1; (*(volatile uint32_t *)&pdev->regs . HC_REGS[num]->HCGINTMSK = GINTMSK . d32);};
    USB_OTG_HC_Halt(pdev, num);
  ...
  else if (hcint.b.nak)
  {
    ...
    { USB_OTG_HCGINTMSK_TypeDef GINTMSK; GINTMSK . d32 = (*(volatile uint32_t *)&pdev->regs . HC_REGS[num]->HCGINTMSK); GINTMSK . b . chhltd = 1; (*(volatile uint32_t *)&pdev->regs . HC_REGS[num]->HCGINTMSK = GINTMSK . d32);};
    USB_OTG_HC_Halt(pdev, num);
    { USB_OTG_HCINTn_TypeDef hcint_clear; hcint_clear . d32 = 0; hcint_clear . b . nak = 1; (*(volatile uint32_t *)&((hcreg)->HCINT) = hcint_clear . d32); };
  ...
  else if (hcint.b.xacterr)
  {
    ...
    { USB_OTG_HCINTn_TypeDef hcint_clear; hcint_clear . d32 = 0; hcint_clear . b . xacterr = 1; (*(volatile uint32_t *)&((hcreg)->HCINT) = hcint_clear . d32); };
  }
  else if (hcint.b.nyet)
  {
    ...
    { USB_OTG_HCGINTMSK_TypeDef GINTMSK; GINTMSK . d32 = (*(volatile uint32_t *)&pdev->regs . HC_REGS[num]->HCGINTMSK); GINTMSK . b . chhltd = 1; (*(volatile uint32_t *)&pdev->regs . HC_REGS[num]->HCGINTMSK = GINTMSK . d32);};
    USB_OTG_HC_Halt(pdev, num);
    { USB_OTG_HCINTn_TypeDef hcint_clear; hcint_clear . d32 = 0; hcint_clear . b . nyet = 1; (*(volatile uint32_t *)&((hcreg)->HCINT) = hcint_clear . d32); };
  ...
  else if (hcint.b.datatglerr)
  {
    ...
    { USB_OTG_HCINTn_TypeDef hcint_clear; hcint_clear . d32 = 0; hcint_clear . b . datatglerr = 1; (*(volatile uint32_t *)&((hcreg)->HCINT) = hcint_clear . d32); };
  }  
  else if (hcint.b.chhltd)
  {
    { USB_OTG_HCGINTMSK_TypeDef GINTMSK; GINTMSK . d32 = (*(volatile uint32_t *)&pdev->regs . HC_REGS[num]->HCGINTMSK); GINTMSK . b . chhltd = 0; (*(volatile uint32_t *)&pdev->regs . HC_REGS[num]->HCGINTMSK = GINTMSK . d32);};
    
    if(pdev->host.HC_Status[num] == HC_XFRC)
    {
      pdev->host.URB_State[num] = URB_DONE;  
      
      if (hcchar.b.eptype == 2)
      {
    ...
    { USB_OTG_HCINTn_TypeDef hcint_clear; hcint_clear . d32 = 0; hcint_clear . b . chhltd = 1; (*(volatile uint32_t *)&((hcreg)->HCINT) = hcint_clear . d32); };    
  }
...
uint32_t USB_OTG_USBH_handle_hc_n_In_ISR (USB_OTG_CORE_HANDLE *pdev , uint32_t num)
{
  ...
  if (hcint.b.frmovrun)
  {
    { USB_OTG_HCGINTMSK_TypeDef GINTMSK; GINTMSK . d32 = (*(volatile uint32_t *)&pdev->regs . HC_REGS[num]->HCGINTMSK); GINTMSK . b . chhltd = 1; (*(volatile uint32_t *)&pdev->regs . HC_REGS[num]->HCGINTMSK = GINTMSK . d32);};
    USB_OTG_HC_Halt(pdev, num);
    { USB_OTG_HCINTn_TypeDef hcint_clear; hcint_clear . d32 = 0; hcint_clear . b . frmovrun = 1; (*(volatile uint32_t *)&((hcreg)->HCINT) = hcint_clear . d32); };
  }
  ...
  else if (hcint.b.xfercompl)
  {
    ...
    {
      hctsiz.d32 = (*(volatile uint32_t *)&pdev->regs . HC_REGS[num]->HCTSIZ);
    ...
    else if(hcchar.b.eptype == 3)
    {
      hcchar.b.oddfrm  = 1;
      (*(volatile uint32_t *)&pdev->regs . HC_REGS[num]->HCCHAR = hcchar . d32); 
      pdev->host.URB_State[num] = URB_DONE;  
    }
  ...
  {  
    if(hcchar.b.eptype == 3)
    {
      { USB_OTG_HCGINTMSK_TypeDef GINTMSK; GINTMSK . d32 = (*(volatile uint32_t *)&pdev->regs . HC_REGS[num]->HCGINTMSK); GINTMSK . b . chhltd = 1; (*(volatile uint32_t *)&pdev->regs . HC_REGS[num]->HCGINTMSK = GINTMSK . d32);};
      USB_OTG_HC_Halt(pdev, num);
      { USB_OTG_HCINTn_TypeDef hcint_clear; hcint_clear . d32 = 0; hcint_clear . b . nak = 1; (*(volatile uint32_t *)&((hcreg)->HCINT) = hcint_clear . d32); };   
    }
     else if  ((hcchar.b.eptype == 0)||
             (hcchar.b.eptype == 2))
    {
...
static uint32_t USB_OTG_USBH_handle_rx_qlvl_ISR (USB_OTG_CORE_HANDLE *pdev)
{
  ...
  grxsts.d32 = (*(volatile uint32_t *)&pdev->regs . GREGS->GRXSTSP);
  channelnum = grxsts.b.chnum;  
  hcchar.d32 = (*(volatile uint32_t *)&pdev->regs . HC_REGS[channelnum]->HCCHAR);
  ...
  case 2:
    ...
    {  
      ...
      hctsiz.d32 = (*(volatile uint32_t *)&pdev->regs . HC_REGS[channelnum]->HCTSIZ);
      if(hctsiz.b.pktcnt > 0)
      {
         
        hcchar.b.chen = 1;
        hcchar.b.chdis = 0;
        (*(volatile uint32_t *)&pdev->regs . HC_REGS[channelnum]->HCCHAR = hcchar . d32);
      }
    }
    break;
  ...
  intmsk.b.rxstsqlvl = 1;
  (*(volatile uint32_t *)&pdev->regs . GREGS->GINTMSK = ((((*(volatile uint32_t *)&pdev->regs . GREGS->GINTMSK)) & ~0) | intmsk . d32 ));
  return 1;
}
...
static uint32_t USB_OTG_USBH_handle_IncompletePeriodicXfer_ISR (USB_OTG_CORE_HANDLE *pdev)
{
    ...
    hcchar.d32 = (*(volatile uint32_t *)&pdev->regs . HC_REGS[0]->HCCHAR);
    hcchar.b.chen = 1;
    hcchar.b.chdis = 1;
    (*(volatile uint32_t *)&pdev->regs . HC_REGS[0]->HCCHAR = hcchar . d32);  
