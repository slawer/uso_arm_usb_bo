...
#line 36 "Libraries\\STM32_USB_HOST_Library\\usbh_msc_core.c"
#line 37 "Libraries\\STM32_USB_HOST_Library\\usbh_msc_core.c"
#line 38 "Libraries\\STM32_USB_HOST_Library\\usbh_msc_core.c"
#line 39 "Libraries\\STM32_USB_HOST_Library\\usbh_msc_core.c"
...
{	 
  ...
  if((pphost->device_prop.Itf_Desc[0].bInterfaceClass == 0x08) &&      (pphost->device_prop.Itf_Desc[0].bInterfaceProtocol == 0x50))
  ...
  {   
    ...
    case USBH_MSC_GET_MAX_LUN:
      ...
      if(status == USBH_OK )
      {
        ...
        if((MSC_Machine.maxLun > 0) && (maxLunExceed == 0))
        {
          maxLunExceed = 1;
          pphost->usr_cb->USBH_USR_DeviceNotSupported();
