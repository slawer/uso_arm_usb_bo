...
{ 
        ...
        if(USART_GetITStatus(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400)), ((uint16_t)0x0626)) != RESET)
        {
		
					USART_ClearITPendingBit(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400)), ((uint16_t)0x0626));
					
					if (txsize>tekper)
						USART_SendData(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400)),TxBuffer[tekper]);
					else
					{
						if (txsize==tekper)
...
void ADC3_CH12_DMA_Config(void)
{
  ...
  RCC_APB2PeriphClockCmd(((uint32_t)0x00000400), ENABLE);

  
  DMA_InitStructure.DMA_Channel = ((uint32_t)0x04000000);  
  DMA_InitStructure.DMA_PeripheralBaseAddr = (uint32_t)((uint32_t)0x4001224C);
  ...
  ADC_Init(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2200)), &ADC_InitStructure);

  
  ADC_RegularChannelConfig(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2200)), ((uint8_t)0x0C), 1, ((uint8_t)0x00));

 
  ADC_DMARequestAfterLastTransferCmd(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2200)), ENABLE);

  
  ADC_DMACmd(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2200)), ENABLE);

  
  ADC_Cmd(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2200)), ENABLE);
}
...
void settime(void)
{
    ...
    {
        TempReg |= ((DayOfWeek & 0x07) << 13); 
    }
    ((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x2800))->DR = TempReg;
		}
    ...
    ((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x2800))->TR = TempReg;
...
void spi_init(){
    ...
    SPI_I2S_DeInit(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3000)));

    SPI_StructInit(&spi1);
    spi1.SPI_Mode = ((uint16_t)0x0104);
    spi1.SPI_DataSize = ((uint16_t)0x0800);
    spi1.SPI_NSS = ((uint16_t)0x0200);
    SPI_Init(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3000)),&spi1);
...
void spi1_init() {
    ...
    SPI_StructInit(&spi1);
    spi1.SPI_Mode = ((uint16_t)0x0104);
    spi1.SPI_DataSize = ((uint16_t)0x0000); 
    spi1.SPI_NSS = ((uint16_t)0x0200);

  spi1.SPI_BaudRatePrescaler = ((uint16_t)0x0038);
  spi1.SPI_FirstBit = ((uint16_t)0x0000);
...
void spi2_init() {
    ...
    GPIO_StructInit(&gpio);
    gpio.GPIO_Pin = ((uint16_t)0x2000) | ((uint16_t)0x4000) | ((uint16_t)0x8000);
    gpio.GPIO_Mode = GPIO_Mode_AF;
    gpio.GPIO_Speed = GPIO_Speed_50MHz;
    gpio.GPIO_OType = GPIO_OType_PP;
    gpio.GPIO_PuPd = GPIO_PuPd_DOWN;
    GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400)),&gpio);
    ...
    SPI_StructInit(&spi2);
    spi2.SPI_Mode = ((uint16_t)0x0000);
    spi2.SPI_DataSize = ((uint16_t)0x0800);
    spi2.SPI_NSS = ((uint16_t)0x0200);
    SPI_Init(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800)),&spi2);
...
uint16_t spi_receve() {
    ...
    received = SPI_I2S_ReceiveData(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800)));
    return received;
}
...
void test_ind_all(void)
{
				GPIO_WriteBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000)), ((uint16_t)0x0001), Bit_RESET); 			
				GPIO_WriteBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000)), ((uint16_t)0x0002), Bit_RESET); 
				GPIO_WriteBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000)), ((uint16_t)0x0004), Bit_RESET);  			
				GPIO_WriteBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000)), ((uint16_t)0x0008), Bit_RESET); 
				GPIO_WriteBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000)), ((uint16_t)0x0010), Bit_RESET);     
				delay_spi(100);
				spi_send(0x0f);delay_spi(100);
				spi_send(0x01); delay_spi(100);
				GPIO_WriteBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000)), ((uint16_t)0x0001), Bit_SET); 			
				GPIO_WriteBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000)), ((uint16_t)0x0002), Bit_SET); 
				GPIO_WriteBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000)), ((uint16_t)0x0004), Bit_SET);  			
				GPIO_WriteBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000)), ((uint16_t)0x0008), Bit_SET); 
				GPIO_WriteBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000)), ((uint16_t)0x0010), Bit_SET);   
				delay_spi(1000);
}
...
void ind_blank_all(void)
{
		u8 i=0,ind=0;
			...
			for (i=1;i<9;i++)
			{
				...
				GPIO_WriteBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000)), ((uint16_t)0x0001), Bit_RESET);      delay_spi(zad_spi);
				spi_send((u8) i);					delay_spi(zad_spi);
				spi_send(0x00);					  delay_spi(zad_spi);			
				GPIO_WriteBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000)), ((uint16_t)0x0001), Bit_SET);      		delay_spi(zad_spi2);
			}
			
			for (i=1;i<9;i++)
			{
				
				GPIO_WriteBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000)), ((uint16_t)0x0002), Bit_RESET);      delay_spi(zad_spi);
				spi_send((u8) i);					delay_spi(zad_spi);
				spi_send(0x00);					  delay_spi(zad_spi);			
				GPIO_WriteBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000)), ((uint16_t)0x0002), Bit_SET);      		delay_spi(zad_spi2);
			}

			for (i=1;i<9;i++)
			{
				
				GPIO_WriteBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000)), ((uint16_t)0x0004), Bit_RESET);      delay_spi(zad_spi);
				spi_send((u8) i);					delay_spi(zad_spi);
				spi_send(0x00);					  delay_spi(zad_spi);			
				GPIO_WriteBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000)), ((uint16_t)0x0004), Bit_SET);      		delay_spi(zad_spi2);
			}
			
			for (i=1;i<9;i++)
			{
				
				GPIO_WriteBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000)), ((uint16_t)0x0008), Bit_RESET);      delay_spi(zad_spi);
				spi_send((u8) i);					delay_spi(zad_spi);
				spi_send(0x00);					  delay_spi(zad_spi);			
				GPIO_WriteBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000)), ((uint16_t)0x0008), Bit_SET);      		delay_spi(zad_spi2);
			}			
}
...
{ 
  ...
  RCC_MCO2Config(((uint32_t)0x00000000), ((uint32_t)0x20000000));
  ...
  ADC_SoftwareStartConv(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2200)));
  ...
  USBH_Init(&USB_OTG_Core, USB_OTG_FS_CORE_ID, &USB_Host, &USBH_MSC_cb, &USR_Callbacks);
    ...
    spi2_init();
		...
		GPIO_InitStructure.GPIO_Pin   = ((uint16_t)0x0002)|((uint16_t)0x0001);  
  ...
  init_ind(4, 4, 0);   
	...
	GPIO_WriteBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0C00)), ((uint16_t)0x0010), Bit_SET);      
	GPIO_WriteBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0C00)), ((uint16_t)0x0008), Bit_SET);    
	((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0C00))->ODR ^= ((uint16_t)0x0008);
...
static void TIM_LED_Config(void)
{
  ...
  TIM_OC1PreloadConfig(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0800)), ((uint16_t)0x0000));
