...
void ADC3_CH12_DMA_Config_new(void)
{
 ...
 // ADC3 Init ***************************************************************
  ...
  // ADC3 regular channel12 configuration ***********************************
	ADC_RegularChannelConfig(ADC1, ADC_Channel_11, 1, ADC_SampleTime_480Cycles); //ADC_SampleTime_3Cycles);   // ДМК
  ADC_RegularChannelConfig(ADC1, ADC_Channel_12, 2, ADC_SampleTime_480Cycles); //ADC_SampleTime_3Cycles);	  // АКБ
